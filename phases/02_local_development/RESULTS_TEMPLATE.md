...
| 7 | `14_Local_Dev_Testing_Envs/01_local_dev_security.md` | Local Dev Security (added) | Medium | Confirm a fresh local dev environment setup never requires copying real production credentials or data. | ☐ Pass ☐ Fail ☐ N/A | | |
